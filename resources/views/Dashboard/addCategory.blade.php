					...
					<ol class="breadcrumb bc-3" >
						...
						<a href="/dashboard"><i class="fa-home"></i>Home</a>
							...
							<li>
									...
									<a href="/listcategories">Categories</a>
							</li>
						<li class="active">
		
									<strong>Add New Category to Products</strong>
							</li>
							</ol>
					
		<h2>Add New Category to Products</h2>
		<br />
					...
					<div class="panel-body">
						...
						<form role="form" method="POST" class="form-horizontal form-groups-bordered" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" name="name" class="form-control" id="field-1" placeholder="Category Name" >
								</div>
							</div>
                            
                            <div class="col-sm-offset-3 col-sm-5">
								
								<input type="submit" name="add" class="btn btn-default" value="Add Category" />
							</div>
						</form>
